...
impl Casing {
    ...
    pub fn convert_words(&self, words: &[String]) -> String {
        match self {
            ...
            // ⚡ Bolt: Use .collect::<String>() instead of .collect::<Vec<_>>().join("") to eliminate an unnecessary intermediate vector allocation
...
pub fn camel_case(value: &str) -> String {
    ...
    match chars.next() {
        None => String::new(),
        // ⚡ Bolt: Use .to_string() instead of .collect::<String>() for more direct allocation using Display
